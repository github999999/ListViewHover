...
public class PopWindowActivity extends Activity implements
		OnClickListener {
		...
		popListView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int pos,
				...
				if (menuIndex == 0) {
					...
					Toast.makeText(PopWindowActivity.this, currentProduct, Toast.LENGTH_SHORT).show();
				} else if (menuIndex == 1) {
					currentSort = menuData2.get(pos).get("name");
					titleTv.setText(currentSort);
					sortTv.setText(currentSort);
					Toast.makeText(PopWindowActivity.this, currentSort, Toast.LENGTH_SHORT).show();
				} else {
					currentActivity = menuData3.get(pos).get("name");
					titleTv.setText(currentActivity);
					activityTv.setText(currentActivity);
					Toast.makeText(PopWindowActivity.this, currentActivity, Toast.LENGTH_SHORT).show();
				}
			}
		});
	}
